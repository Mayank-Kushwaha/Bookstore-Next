  ...
  return (
    <div className="max-w-6xl w-full mx-auto px-4 py-6 justify-start md:px-8">
      ...
      <p className="font-main text-normal my-4  mr-auto md:text-lg">
        ...
        with our services, or make purchases through our platform.<br></br><br></br>
        ...
        allowing us to improve our services.<br></br><br></br>
        ...
        respond to legal requests.<br></br><br></br>
        ...
        activities, you can withdraw it at any time.<br></br><br></br>
